...
echo Updates component version on UrbanCode Deploy ...
echo.

@REM Check JAVA_HOME
if "%JAVA_HOME%" == "" (
  set JAVA_EXE="C:\DevOps\Java\jdk1.8.0_71\bin\java.exe"
) else (
...
%JAVA_EXE% %JVM_OPTS% -classpath "%CLASSPATH%" com.devops.urbancode.admin.UdeployUpdate %CMD_LINE_ARGS%

...
echo Uploda artifacts to artifactory and udeploy server ...
echo.
...
%JAVA_EXE% %JVM_OPTS% -classpath "%CLASSPATH%" com.cppib.coretech.devops.versions.ArtifactoryUpload %CMD_LINE_ARGS%

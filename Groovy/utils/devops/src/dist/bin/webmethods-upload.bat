...
echo Uploda webmethods deploy file to artifactory and udeploy server ...
echo.
...
%JAVA_EXE% %JVM_OPTS% -classpath "%CLASSPATH%" com.cppib.coretech.devops.versions.WebmethodsUploader %CMD_LINE_ARGS%

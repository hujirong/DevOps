...
echo Upload DataStage project files to UrbanCode Deploy ...
echo.
...
%JAVA_EXE% %JVM_OPTS% -classpath "%CLASSPATH%" com.cppib.coretech.devops.versions.DataStageVersionUploader %CMD_LINE_ARGS%

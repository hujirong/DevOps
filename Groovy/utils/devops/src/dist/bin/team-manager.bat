...
echo Manage team resources (component, component template, application, process, resource ...
echo.
...
%JAVA_EXE% %JVM_OPTS% -classpath "%CLASSPATH%" com.cppib.coretech.devops.admin.TeamManager %CMD_LINE_ARGS%
